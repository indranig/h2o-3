...
#    print, str, as.numeric, as.character, as.factor, apply, cos, sin, acos, cosh, tan, tanh, exp, log,
...
#' summary(h2o.apply(iris.hex, 2, sum))
#' }
#' @export
h2o.apply <- function(X, MARGIN, FUN, ...) {
    if(is.H2OFrame(x)) apply(X,MARGIN,FUN,...)
